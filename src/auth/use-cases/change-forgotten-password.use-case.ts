import { IChangePasswordDto } from '../application/dto/change-password.dto';
...
import { changeForgottenPasswordValidator } from '../application/validators/change-forgotten-password.validator';

export class ChangeForgottenPasswordUseCase {
  constructor(
